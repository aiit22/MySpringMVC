package lee.sample.framework.util.dataaccess;
 ...
 * </pre>
 */
public class IbatisAbstractDAO extends SqlMapClientDaoSupport {

    /**
     * EgovAbstractDAO 는 base class 로만 사용되며 해당 인스턴스를 직접
     * 생성할 수 없도록 protected constructor 로 선언하였음.
     */
    protected IbatisAbstractDAO() {
     ...
     *        delete 등) 의 실행을 지원함.
     */
    @Resource(name = "ibatisSqlMapClient")
